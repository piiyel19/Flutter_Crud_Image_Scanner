...
class UpdateImage extends StatefulWidget {
  ...
  UpdateImage({this.list, this.index});
...
class UploadImageDemoState extends State<UpdateImage> {
  //
  static final String uploadEndPoint =
      'http://192.168.56.1/api_flutter/upload_update_image.php';
  Future<File> file;
  String status = '';
  String base64Image;
  File tmpFile;
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            ...
            //     new MaterialPageRoute(builder: (context) => new CrudImage())),
            onPressed: () {
              Navigator.pop(context);
            }),
